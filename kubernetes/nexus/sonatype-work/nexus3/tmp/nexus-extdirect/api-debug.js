...
NX.direct.api.REMOTING_API = {
  ...
  actions: {
    ...
    ldap_LdapServer: [
      {
        name: 'verifyLogin'/*(com.sonatype.nexus.ldap.internal.ui.LdapServerXO, String, String) => void */,
        len: 3,
        formHandler: false
      },
      {
        name: 'verifyConnection'/*(com.sonatype.nexus.ldap.internal.ui.LdapServerConnectionXO) => void */,
        len: 1,
        formHandler: false
      },
      {
      ...
      {
        name: 'verifyUserMapping'/*(com.sonatype.nexus.ldap.internal.ui.LdapServerXO) => java.util.Collection */,
        len: 1,
        formHandler: false
      },
      {
      ...
      {
        name: 'update'/*(com.sonatype.nexus.ldap.internal.ui.LdapServerXO) => com.sonatype.nexus.ldap.internal.ui.LdapServerXO */,
        len: 1,
        formHandler: false
      },
      {
        name: 'create'/*(com.sonatype.nexus.ldap.internal.ui.LdapServerXO) => com.sonatype.nexus.ldap.internal.ui.LdapServerXO */,
        len: 1,
        formHandler: false
      },
      {
